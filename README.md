![Banner Profile](https://media.licdn.com/dms/image/v2/D4D16AQE2T_sh7Sxlqg/profile-displaybackgroundimage-shrink_350_1400/profile-displaybackgroundimage-shrink_350_1400/0/1714174581207?e=1766016000&v=beta&t=S6JuYvfmcNEbF_xUiB-LCEXAzhDkQH8lGWge8nN-LBU)
...
Sou um profissional **polímata** que integra estudos constantes em **Tecnologia da Informação** com uma bagagem robusta de **Administração** e **Educação**. Atualmente focado no desenvolvimento Full Stack e na intersecção entre Tecnologia, **Arte** e **Desenvolvimento Humano** (EdTech/HealthTech).
...
### 📚 Minha Jornada Acadêmica (Os 3 Pilares)

#### 1. 💻 Tecnologia (O Foco Atual)
...
| ✅ **Concluído** | Certificações Técnicas | Lógica, HTML5, CSS3, PHP8, SQL, GitHub, iAs, Python3, ML, Linux |
...
### 🎨 Projetos & Interesses Criativos
*Além do código, sou músico e pesquisador de temas espirituais.*

* **🎵 Álbum autoral ELOnARTE (Fev/2026):** Composição e produção de World Music (Jazz, Bossa Nova, MPB, Folk, Rock Progressivo, Soul, Celtic, New Age etc) inspiradas na Consciência Divina, Arquétipos Maias e espiritualidade.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://LinkedIn.com/in/leonarte)
[![Portfolio](https://img.shields.io/badge/Portfolio-ELOnARTE-FF5722?style=for-the-badge&logo=google-chrome&logoColor=white)](https://elonarte.com)
