...
| 🚀 **Em Curso** | Formações Dio.me | JavaScript, Node.js, React |
| ✅ **Concluído** | Pós em Gestão de TI (GTI) | Governança, ITIL |
| ✅ **Concluído** | Certificações Técnicas | Lógica, HTML5, CSS, PHP, SQL, GitHub, Python, Linux |

#### 2. 🧠 Humanidades & Educação (O Diferencial)
*Entendendo pessoas e processos de aprendizado*
* **Pós-Graduação:** Neurociências, Linguagens e Filosofia *(Em breve)*
* **Pós-Graduação:** Arteterapia | Arte e Educação
* **Pós-Graduação:** Docência no Ensino Básico e Superior
...
* **🎵 Álbum Autoral ELOnARTE (Dez/2025):** Composição e produção de World Music (Jazz, Bossa Nova, MPB, Folk, Rock Progressivo, Soul, Celtic, New Age etc) inspiradas em Arquétipos Maias e espiritualidade.
...
[**LinkedIn**](https://LinkedIn.com/in/leonarte) • [**Portfólio / Site**](https://elonarte.com)
